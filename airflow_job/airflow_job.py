...
with DAG(
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "1063125472657-compute@developer.gserviceaccount.com",
                "network_uri": "projects/kubernetes-123-438218/global/networks/default",
                "subnetwork_uri": "projects/kubernetes-123-438218/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="kubernetes-123-438218",
        region="us-central1",
